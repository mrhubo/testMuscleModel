...
namespace ceinms {
    ...
    public:
        ...
        void   setActivationScale(double activationScale);
        double getActivationScale() const { return activationScale_; }
        ...
        void setPercentFastTwitch(double percentFastTwitch);
    ...
    private:
        ...
        double activationScale_; /*//activation scaling factor*/
        ...
        // Muscle Energy Expenditure Model
        double act_mainHeatRate_;
        double shorteningHeatRate_;
        double lengtheningHeatRate_;
        double workRate_;
		double heatRate_;
        double shorteningHeatCoeST_;
        double shorteningHeatCoeFT_;
        double lengtheningHeatCoe_;
        
        double muscleMass_;
        double percentFastTwitch_;
