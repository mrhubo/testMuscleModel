...
namespace ceinms {
    ...
    ExponentialActivation::ExponentialActivation() :
        ...
        neuralActivationT1_(0.0), neuralActivationT2_(0.0), activation_(0.0), expShapeFactor_(0.0), activationScale_(1.)
    ...
    void ExponentialActivation::setActivationScale(double activationScale) {
    ...
    void ExponentialActivation::updateActivation() {
        ...
        activation_ = activationScale_*(exp(shapeFactor_*neuralActivation_) - 1) / (expShapeFactor_ - 1);
    }
